...
def plot_results(routes, waypoints, num_vehicles):
    x = []
    y = []
...
def main():
    ...
    route0 = [ 0,  3,  12,  16,  15,  11,  5,  7,  6,  1,  2, 0]
    route1 = [0,  9,  13,  17,  19,  18,  14,  10,  8,  4, 0]
    routes = [route0, route1]
        # routes, max_route_distance = print_solution(data, manager, routing, solution)

    plot_results(routes, waypoints, num_vehicles)
